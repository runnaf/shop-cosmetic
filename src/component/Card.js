...
export function Card({ className, arrayData, numberCards, page }) {
  ...
  return (
    <>
      <ul className={className ? className + " card-list" : "card-list"}>
        {cardsOnList.map((item, id) => {
      ...
      <div className="blog__navigation">
        <button
          type="button"
          className="blog__button-navigation"
          onClick={prevList}
        >
          ...
          {lists.map((item) => {
            return (
              <li key={item} className="page-item">
                <Link
                  to="#!"
                  className={cardPage === item ? "current-page page" : "page"}
                  onClick={() => functionChange(item)}
                >
                  {item}
                </Link>
              </li>
        ...
        <button
          type="button"
          className="blog__button-navigation blog__button-navigation--next"
          onClick={nextList}
        >
